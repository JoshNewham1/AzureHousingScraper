...
export const scrapeGumtree = async (context: Context) => {
  const startingUrl =
    "https://www.gumtree.com/search?search_category=property-to-rent&search_location=eh11jt&q=&min_price=&max_price=&min_property_number_beds=3&max_property_number_beds=5";
